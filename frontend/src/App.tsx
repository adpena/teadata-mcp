...
const TransferInsightsView = lazy(() => import('./TransferInsightsView').then(module => ({ default: module.TransferInsightsView })));
...
function AppContent() {
  ...
  const renderContent = () => {
    ...
    if (view.type === 'transfer_insights') {
      return (
        <Suspense fallback={<div className="flex justify-center p-10"><Loader2 className="animate-spin" /></div>}>
          <TransferInsightsView />
        </Suspense>
      );
    }
    ...
    <div className="min-h-screen bg-white text-gray-900 p-4 pb-24">
      {view.type !== 'home' && (
        <div className="mb-4 print:hidden">
          <Button variant="ghost" onClick={() => setView({ type: 'home' })} color="primary">
