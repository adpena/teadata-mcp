...
def main():
    ...
    config_path = Path(os.path.expanduser("~/Library/Application Support/OpenAI/ChatGPT/mcp.json"))
    ...
    if config_path.exists():
        try:
            ...
            print(f"Warning: {config_path} contained invalid JSON. Overwriting with new config.")
